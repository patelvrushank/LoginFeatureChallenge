...
import androidx.compose.ui.tooling.preview.Devices.PIXEL_9_PRO_FOLD
                        ...
                        LaunchedEffect(Unit) {
                            vm.uiEvent.collect {
                                when (it) {
                                    ...
                                    is UiEvent.ShowToast -> Toast.makeText(context,it.msg, Toast.LENGTH_SHORT).show()
                                }
...
/*
@Preview(showBackground = true, device = PIXEL_9_PRO_FOLD)
@Composable
